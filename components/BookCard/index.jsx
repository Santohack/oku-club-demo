      ...
      >
        ...
        <div className="flex gap-4 items-center">
          ...
          onMouseLeave={handleMouseLeave}>
            ...
            >
              <Bookmark className={` ${onHover && "text-red-500" }`} />
            </button>
            </div>
            <span className="hidden md:inline-block ml-2">{onHover ? "save for later" : "To read"}</span>
          </div>
          <div className="my-3 flex flex-col justify-center items-center gap-2"
          ...
          onMouseLeave={handleMouseLeave1}>
            ...
            >
              <Eye className={` ${onHover1 && "text-yellow-500" }`} />
            </button>
            <span className="hidden md:inline-block ml-2">{onHover1 ? " Mark as read" : "Reading"}</span>
          </div>
          <div className="my-3 flex flex-col justify-center items-center gap-2"
          ...
          onMouseLeave={handleMouseLeave2}>
            ...
            >
              <Check className={` ${onHover2 && "text-green-500" }`}/>
            </button>
            <span className={`hidden md:inline-block ml-2 ${onHover2 && "text-green-500"}`}> {onHover2 ? "Mark as finished" : "Read"}</span>
          </div>
        </div>
      </div>
    </div>
